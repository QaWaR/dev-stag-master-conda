                ...
                <div class="row mb-5">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="campaign card mb-4">  
                            ...
                            <div class="campaign-content card-body bg-light"><!-- CAMPAIGN TITLE AND EXCERT(SUMMARY ABOUT COMPANY), WITH INVESTMENT STATUS-->       
                                ...
                                <p class="campaign-excerpt card-text mt-3 text-secondary">Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde dignissimos a vitae recusandae amet itaque perferendis
                                ...
                                <div class="campaign-invest-wrapper text-dark d-flex flex-column flex-sm-row justify-content-around"><!-- CAMPAIGN KNOB(SCALE) WITH CURRENT INVESTMENT STATUS AND BASIC INFO-->   
                                    <div class="campaign-invest-scale rounded-circle border border-secondary p-3  mr-3 text-center text-secondary"><!-- SCALE -->
                                    ...
                                    <div class="investment-amounts align-self-center pt-3"><!-- BASIC INFO ABOUT INVESTMENTS -->
                                        <p class="text-muted"><span class="investment-min d-block h4 m-0 text-secondary">75.000<sup class="currency">&euro;</sup></span> Minimum Investment</p>
                                        <p class="text-muted"><span class="investment-max d-block h4 m-0 text-secondary">700.000<sup class="currency">&euro;</sup></span> Maximum investment</p>
                                    </div> <!--END-->
                                </div>       
                            </div>  
                    ...
                    <div class="col-12 col-md-6">
                        <div class="campaign card mb-4">  
                            ...
                            <div class="campaign-content card-body bg-light"><!-- CAMPAIGN TITLE AND EXCERT(SUMMARY ABOUT COMPANY), WITH INVESTMENT STATUS-->       
                                ...
                                <div class="campaign-invest-wrapper text-dark d-flex flex-column flex-sm-row justify-content-around"><!-- CAMPAIGN KNOB(SCALE) WITH CURRENT INVESTMENT STATUS AND BASIC INFO-->    
                                    <div class="investment-amounts align-self-center pt-3"><!-- BASIC INFO ABOUT INVESTMENTS -->
                                        <p class="text-muted"><span class="investment-min d-block h4 m-0 text-secondary text-center">450.000<sup class="currency">&euro;</sup></span> Capital Investment</p>
                                    </div> <!--END-->
                                </div>       
                            </div>  
                            <div class="card-footer p-0"><!-- CAMPAIGN ADDITIONAL INFO, CELLS WITH ICONS AND BUTTON FOR MORE INFO -->       
                            ...
                            <div class="card-footer p-0"><!-- CAMPAIGN ADDITIONAL INFO, CELLS WITH ICONS AND BUTTON FOR MORE INFO -->
                                <div class="campaign-invest-info py-1 d-flex flex-wrap justify-content-around border-bottom border-muted"><!--ADDITIONAL INFORMATION DISPLAYED AS ICONS WITH TOOLTIPS-->
                                    ...
                                    <div class="info-cell mx-1 px-2 py-2 text-center">
                                        ...
                                        <span class="d-block text-secondary font-weight-bold">0.00</span>
                                    </div>
                                    <div class="info-cell mx-1 px-2 py-2 text-center">
                        ...
                        <div class="campaign card mb-4">  
                            ...
                            <div class="campaign-content card-body bg-light"><!-- CAMPAIGN TITLE AND EXCERT(SUMMARY ABOUT COMPANY), WITH INVESTMENT STATUS-->       
                                ...
                                <div class="campaign-invest-wrapper text-dark d-flex flex-column flex-sm-row justify-content-around"><!-- CAMPAIGN KNOB(SCALE) WITH CURRENT INVESTMENT STATUS AND BASIC INFO-->   
                                    ...
                                    <div class="investment-amounts align-self-center pt-3"><!-- BASIC INFO ABOUT INVESTMENTS -->
                                        <p class="text-muted"><span class="investment-min d-block h4 m-0 text-secondary">55.000<sup class="currency">&euro;</sup></span> Minimum Investment</p>
                                        <p class="text-muted"><span class="investment-max d-block h4 m-0 text-secondary">550.000<sup class="currency">&euro;</sup></span> Maximum investment</p>
                                    </div> <!--END-->
                                </div>       
                            </div>  
                            <div class="card-footer p-0"><!-- CAMPAIGN ADDITIONAL INFO, CELLS WITH ICONS AND BUTTON FOR MORE INFO -->
                            ...
                            <div class="card-footer p-0"><!-- CAMPAIGN ADDITIONAL INFO, CELLS WITH ICONS AND BUTTON FOR MORE INFO -->
                                <div class="campaign-failed p-2 d-flex flex-row justify-content-around border-bottom border-muted"><!--THIS SECTION ONLY IF CAMPAIGN FAILS-->
                                    <div class="investment-amounts align-self-center pt-3">
                                        <p class="text-muted">
                                            <span class="investment-min d-block h3 m-0 text-secondary">
                                                0<sup class="currency">&euro;</sup>
                                            </span> Supports
                                        </p>
                                        <p class="text-muted">
                                            <span class="investment-max h4 m-0 text-secondary">0</span> Supporter
                                        </p>
                                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="campaign card mb-4">  
                            ...
                            <div class="campaign-content card-body bg-light"><!-- CAMPAIGN TITLE AND EXCERT(SUMMARY ABOUT COMPANY), WITH INVESTMENT STATUS-->       
                                ...
                                <!-- SHORT SUMMARY - EXCERT -->
                                <p class="campaign-excerpt card-text mt-3 text-secondary">Roll on, deep and dark blue ocean, roll. Ten thousand fleets sweep over thee in vain. Man marks the earth with ruin, but his control stops with the shore. Repudiandae consequatur
                                    doloremque error culpa quasi itaque?</p> <!--END-->     
                            </div>  
                            <div class="card-footer p-0"><!-- CAMPAIGN ADDITIONAL INFO, CELLS WITH ICONS AND BUTTON FOR MORE INFO -->
                                <div class="campaign-failed p-2 d-flex flex-row justify-content-around border-bottom border-muted"><!--THIS SECTION ONLY IF CAMPAIGN FAILS-->
                                    <div class="investment-amounts align-self-center pt-3">
                                        ...
                                        <p class="text-muted">
                                            <span class="investment-max h4 m-0 text-secondary">10</span> Supporters
                                        </p>
                                    </div>
                                    <div class="completed-wrapper my-auto d-inline-block rounded-circle bg-info p-3 text-white text-center">
                                        <p class="m-0 h3">21%</p>
                        ...
                        <div class="campaign card mb-4">  
                            ...
                            <div class="campaign-content card-body bg-light"><!-- CAMPAIGN TITLE AND EXCERT(SUMMARY ABOUT COMPANY), WITH INVESTMENT STATUS-->       
                                ...
                                <div class="campaign-invest-wrapper text-dark d-flex flex-column flex-sm-row justify-content-around"><!-- CAMPAIGN KNOB(SCALE) WITH CURRENT INVESTMENT STATUS AND BASIC INFO-->   
                                    ...
                                    <div class="investment-amounts align-self-center pt-3"><!-- BASIC INFO ABOUT INVESTMENTS -->
                                        <p class="text-muted"><span class="investment-min d-block h4 m-0 text-secondary">35.000<sup class="currency">&euro;</sup></span> Minimum Investment</p>
                                        <p class="text-muted"><span class="investment-max d-block h4 m-0 text-secondary">180.000<sup class="currency">&euro;</sup></span> Maximum investment</p>
                                    </div> <!--END-->
                                </div>       
                            </div>  
                            <div class="card-footer p-0"><!-- CAMPAIGN ADDITIONAL INFO, CELLS WITH ICONS AND BUTTON FOR MORE INFO -->        
